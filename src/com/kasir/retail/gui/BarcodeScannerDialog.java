...
public class BarcodeScannerDialog extends JDialog {
    ...
    private class LocalWebcamFeed implements CameraFeed {
        ...
        @Override
        public String getDisplayName() { return webcam.getName(); }
    }
    ...
    private class IpCameraFeed implements CameraFeed {
        ...
        @Override
        public String getDisplayName() { return "IP Camera: " + streamUrl; }
    }
    ...
    private KasirService service;
    private Runnable onScanCallback;
    ...
    public BarcodeScannerDialog(JFrame parent, KasirService service, Runnable onScanCallback) {
        super(parent, "Scan Barcode - Kamera", true);
    ...
    private JPanel createHeader() {
        ...
        panel.setPreferredSize(new Dimension(540, 70));
        panel.setLayout(new GridBagLayout());

        JLabel title = new JLabel("SCAN BARCODE KONTINU");
    ...
    private JPanel createCameraSourceBar() {
        ...
        ipUrlField = new JTextField("http://192.168.1.100:8080/video"); // IP Webcam: .../video, DroidCam: ...:4747/video
    ...
    private void connectToIpCamera() {
        ...
        statusLabel.setForeground(ThemeManager.TEXT_SUBTLE);
        resultLabel.setText("Mohon tunggu...");
        ...
        checkTimer.addActionListener(e -> {
            ...
            } else if (currentFeed != null && currentFeed instanceof IpCameraFeed && !((IpCameraFeed) currentFeed).connected) {
    ...
    private JPanel createCameraPanel() {
        ...
        statusLabel = new JLabel("Arahkan barcode ke dalam kotak", SwingConstants.CENTER);
        ...
        layeredPane.setPreferredSize(new Dimension(480, 270));

        previewPanel.setBounds(0, 0, 480, 270);
        overlayPanel.setBounds(0, 0, 480, 270);
    ...
    private JPanel createBottomPanel() {
        ...
        feedbackPanel.setPreferredSize(new Dimension(0, 40));

        resultLabel = new JLabel("Menunggu scan...", SwingConstants.CENTER);
        ...
        historyPanel.setBackground(ThemeManager.CARD_BG);
        historyPanel.setBorder(BorderFactory.createEmptyBorder(5, 0, 5, 0));

        JLabel historyTitle = new JLabel("Daftar Hasil Scan Sesi Ini:");
        historyTitle.setFont(ThemeManager.FONT_BOLD);
        ...
        String[] cols = {"Waktu", "Kode", "Nama Produk", "Harga"};
        ...
        historyTable.getTableHeader().setPreferredSize(new Dimension(0, 28));
        ...
        historyTable.getColumnModel().getColumn(2).setPreferredWidth(180);
        ...
        JButton btnClose = ThemeManager.createButton("SELESAI", ThemeManager.DANGER);
        btnClose.setPreferredSize(new Dimension(180, 38));
    ...
    private void processBarcodeResult(String barcode) {
        try {
            Product product = service.getProductByCode(barcode);
            if (product != null) {
                service.addToCart(product.getCode(), 1);

                java.awt.Toolkit.getDefaultToolkit().beep();

                SwingUtilities.invokeLater(() -> {
                    resultLabel.setText("Terdeteksi: " + product.getName() + " (Rp" + String.format("%,.0f", product.getPrice()) + ")");
                    resultLabel.setForeground(ThemeManager.SUCCESS);
                    statusLabel.setText("SCAN BERHASIL!");
                    statusLabel.setForeground(ThemeManager.SUCCESS);
                ...
                SwingUtilities.invokeLater(() -> {
                    resultLabel.setText("Kode tidak terdaftar: " + barcode);
                    resultLabel.setForeground(ThemeManager.DANGER);
                    statusLabel.setText("PRODUK TIDAK DITEMUKAN");
                    statusLabel.setForeground(ThemeManager.DANGER);
                });
            }
        } catch (Exception e) {
